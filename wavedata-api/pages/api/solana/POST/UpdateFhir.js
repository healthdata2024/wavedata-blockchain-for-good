export default async function handler(req, res) {
	...
	await sendTransaction(api, signerAddress, "UpdateFhir", [Number(userid), walletaddress, patient_details["name"][0]['family'], givenname, identifier, patient_details["telecom"][0]["value"].toString(), patient_details["gender"], patient_details["birthDate"], "decodedDisease", patientid]);
